...
const Portfolio = () => {
  ...
  return (
    <div className="flex flex-col">
      <section className="w-full bg-white dark:bg-[#1f2a3e] py-20 lg:py-32 md:max-w-4xl mx-auto px-4">
            ...
            categories.map((category) =>
              <button
                ...
                className={`
                  ...
                  transition-all
                  duration-500
                  ${selectedOption.toLowerCase() == category.title.toLowerCase() ? 'bg-[#1f2a3e] text-white' : 'bg-gray-50'}
                `}
