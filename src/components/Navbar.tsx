...
const Navbar = () => {
  ...
  return (
    <nav className="flex text-center md:text-left md:justify-between py-8 px-6 bg-white dark:bg-[#1f2a3e] items-center w-full">
      ...
      >
        ...
        <Link to="/blog" className="md:text-lg text-2xl dark:text-neutral-100 no-underline md:ml-2 md:pr-0 md:pl-0 pl-8 pr-24">
          Blog
        </Link>
